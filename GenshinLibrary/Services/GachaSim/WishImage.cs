        ...
        public Stream GetImage()
        {
            ...
            for (int i = 0; i < _items.Length; i++)
            {
                ...
                if (_items[i].WishItem.Rarity != 3)
                {
                    ...
                    bitmap.Mutate(ctx => ctx.DrawText($"Pity: {pity+1}", new Font(SystemFonts.Find("Impact"), 14), new Color(new Argb32(255, 255, 255, 190)), new PointF(wishRect.Left+5, wishRect.Y+5)));
                }
            }
